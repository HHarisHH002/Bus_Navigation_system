import sys
class Node:
    def __init__(self,data,route,point1,point2):
        self.route=route
        self.data = data
        self.parent = None
        self.left = None
...
class AVLTree:
    ...
    def searchTree(self, k):
        x=self.__searchTreeHelper(self.root, k)
        return x
    ...
    def insert(self, key,route,point1,point2):
        # PART 1: Ordinary BST insert
        node = Node(key,route,point1,point2)
        y = None
        x = self.root
